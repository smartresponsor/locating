...
- Fixed BatchController wiring to App\\Service\\Locator\\BatchService.
...
- Updated tests:
  - BatchControllerTest now extends PHPUnit TestCase and uses App\\Service\\Locator\\BatchService.
