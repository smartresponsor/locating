...
final class LocationBatchServicesConfigTest extends TestCase
{
    public function testServicesConfigContainsAppBatchAliasesAndWiring(): void
    {
        ...
        self::assertStringContainsString('use App\Locating\\Service\\Batch\\Location\\LocationAddressBatchService;', $contents);
        self::assertStringContainsString('use App\Locating\\Service\\Batch\\Location\\LocationAddressBatchServiceMetricDecorator;', $contents);
