...
namespace App\Locating\Integration\Provider\Location\Provider\Batch;
...
final class JobStore
{
    ...
    {
        return $this->dir.'/'.preg_replace('/[^a-zA-Z0-9_-]/', '_', $id).'.json';
    }
    ...
    {
        $p = $this->path((string)$job['id']);
        file_put_contents($p, json_encode($job));
    }
    /** @return list<string> */
