...
final class Policy{
  ...
  public static function fromEnv(): self{
    ...
    if($json!==''){ $cfg=json_decode($json,true)?:[]; }
    else{
      $cfg=['defaults'=>{'forward':['nominatim','mock'],'reverse':['nominatim','mock']},'regions':{'eu':{'forward':['nominatim'],'reverse':['nominatim']},'global':{'forward':['photon','mock'],'reverse':['mock']}}];
    }
    return new self($cfg);
  }
}
