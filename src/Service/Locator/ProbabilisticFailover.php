...
use App\Bridge\Legacy\Service\Location\ProbabilisticFailoverLegacyInterface;

final class ProbabilisticFailover implements ProbabilisticFailoverLegacyInterface
{
