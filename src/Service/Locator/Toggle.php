...
use App\Bridge\Legacy\Service\Location\ToggleLegacyInterface;

final class Toggle implements ToggleLegacyInterface
{
    ...
    public function isEnabled(string $key, string $tenantId = '', int $seed = 0): bool
    {
        ...
        if (isset($row['tenant']) && '' !== $tenantId && $row['tenant'] !== $tenantId) {
            return false;
        }
