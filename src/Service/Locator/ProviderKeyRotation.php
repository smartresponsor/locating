...
use App\Bridge\Legacy\Provider\Location\ProviderKeyRotationLegacyInterface;

final class ProviderKeyRotation implements ProviderKeyRotationLegacyInterface
{
