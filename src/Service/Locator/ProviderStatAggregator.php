...
use App\Bridge\Legacy\Provider\Location\ProviderStatAggregatorLegacyInterface;

final class ProviderStatAggregator implements ProviderStatAggregatorLegacyInterface
{
