...
use App\Bridge\Legacy\Service\Location\RegionQuotaSchedulerLegacyInterface;

final class RegionQuotaScheduler implements RegionQuotaSchedulerLegacyInterface
{
    ...
    public function split(int $total, array $weight): array
    {
        ...
        // Store
        $this->q = [];
        foreach ($alloc as $r => $cap) {
            $this->q[$r] = ['cap' => max(0, $cap), 'used' => 0];
        }
