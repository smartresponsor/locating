...
final class LocationProviderGovernanceRecommendationService implements LocationProviderGovernanceRecommendationServiceInterface
{
    public function __construct(private readonly LocationProviderGovernanceExplanationServiceInterface $explanationService)
    {
    }
