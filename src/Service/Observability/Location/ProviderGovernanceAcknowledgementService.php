...
final class ProviderGovernanceAcknowledgementService implements ProviderGovernanceAcknowledgementServiceInterface
{
    public function __construct(private readonly ProviderGovernanceExecutionServiceInterface $execution)
    {
    }
