...
use App\Locating\ServiceInterface\Provider\Location\Credential\ProviderKeyRotationInterface;

final class ProviderKeyRotationService implements ProviderKeyRotationInterface
{
