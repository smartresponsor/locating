...
use App\Locating\ServiceInterface\Provider\Location\ProviderAuthzPolicyInterface;

final class ProviderAuthzPolicyService implements ProviderAuthzPolicyInterface
{
